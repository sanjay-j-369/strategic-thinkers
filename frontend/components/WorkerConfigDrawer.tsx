...
export function WorkerConfigDrawer({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="left-auto right-0 top-0 max-h-screen w-full max-w-[520px] translate-x-0 gap-0 border-l border-border bg-card p-0 shadow-none sm:max-w-[520px]">
