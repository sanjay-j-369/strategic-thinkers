...
function NavBar() {
  ...
  // Unified right-side actions: exactly 32px gap between items
  const rightActions = (
    <>
      <ThemeToggle />
      {loading ? (
        ...
        // Not authenticated + not on auth page: show both buttons
        <>
        ...
        // On auth page (sign-in/sign-up): only show Sign Up pill to avoid clutter
        <Button asChild size="sm" className="px-6">
          <Link href="/sign-up">Sign Up</Link>
        </Button>
      )}
  ...
  return (
    <header className="top-app-bar">
      <div className="top-app-bar-content">
        ...
        {/* Unified right actions: 32px gap between items */}
