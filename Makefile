...
.PHONY: help infra-up infra-down dev-sim dev-sim-bg dev-real dev-real-bg dev-demo dev-demo-bg deploy-dev deploy-demo deploy-prod down logs logs-app logs-workers ps restart rebuild clean
